...
public class StepDefHotelBooking {
	...
	//driver = new FirefoxDriver();
		System.setProperty("webdriver.chrome.driver","C:\\driver\\driver88\\chromedriver.exe");
...
public void user_is_on_hotel_booking_page() throws Throwable {
	...
	//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	//objhbpg = new HotelBookingPageFactory(driver);
	driver.get("C:\\Users\\premksin\\Downloads\\hotel  booking.html");
}
...
public void navigate_to_welcome_page() throws Throwable {
	driver.navigate().to("C:\\Users\\premksin\\Downloads\\hotel  booking.html");
